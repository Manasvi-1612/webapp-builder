...
import { menuButtons, menuLinks } from "@/constants"
import { Separator } from "../ui/separator"
import { Button } from "../ui/button"

const Main = () => {
    return (
        <section className="pt-10 text-[#4B5665]">
            <h1 className="text-[#2C384A] p-normal-48 pb-3" data-aos="zoom-in">Best Website builders in the US</h1>
            <Separator className="border border-[#E1E4E6]" />
            <section className="flex flex-col md:flex-row-between py-2 p-normal-14 gap-3 md:gap-0" data-aos="zoom-in">
                <div className="flex flex-col md:flex-row gap-5">
                    <div className="flex gap-2 tracking-tight">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fillRule="evenodd" clipRule="evenodd" d="M3.66534 3.99892C5.28581 2.46375 7.52625 1.51318 9.99984 1.51318C12.4734 1.51318 14.7138 2.46375 16.3343 3.99892C17.9547 5.53411 18.9582 7.65663 18.9582 10C18.9582 12.3434 17.9547 14.4659 16.3343 16.0011C14.7138 17.5362 12.4734 18.4869 9.99984 18.4869C7.52625 18.4869 5.28581 17.5362 3.66534 16.0011C2.04488 14.4659 1.0415 12.3434 1.0415 10C1.0415 7.65663 2.04488 5.53411 3.66534 3.99892ZM9.99984 2.69739C7.87109 2.69739 5.94486 3.51412 4.54921 4.83629C3.15359 6.15848 2.2915 7.98332 2.2915 10C2.2915 12.0168 3.1536 13.8416 4.54923 15.1637C5.94486 16.4859 7.87109 17.3027 9.99984 17.3027C12.1286 17.3027 14.0548 16.4859 15.4504 15.1637C16.8461 13.8416 17.7082 12.0168 17.7082 10C17.7082 7.98332 16.8461 6.15847 15.4504 4.83629C14.0548 3.51412 12.1286 2.69739 9.99984 2.69739Z" fill="#626E79" />
                            <path fillRule="evenodd" clipRule="evenodd" d="M14.6084 7.21285C14.8525 7.44408 14.8525 7.81899 14.6084 8.05022L9.60845 12.787C9.36437 13.0183 8.96864 13.0183 8.72456 12.787L6.22456 10.4186C5.98048 10.1874 5.98048 9.81251 6.22456 9.58127C6.46864 9.35004 6.86437 9.35004 7.10845 9.58127L9.16651 11.531L13.7246 7.21285C13.9686 6.98162 14.3644 6.98162 14.6084 7.21285Z" fill="#626E79" />
                        </svg>
                        <p>Last Updated - <span className="text-[13px] pl-1">February 22, 2020</span></p>
                    </div>
                ...
                <div className="flex tracking-tight gap-1">
                    Top Relevant
            ...
            <div className="flex flex-wrap py-4 gap-4">
                {menuButtons.map((link, index) => (
                    <Button key={index} className="bg-white pl-4 pr-12 py-2 rounded-xl p-normal-13 tracking-tight hover:bg-gray-500/10 shadow-sm">
                        {link}
                    </Button>
                ))}
            </div>

            <div className="flex flex-wrap pb-6 gap-[10px]">
                {menuLinks.map((link, index) => (
                    <div key={index} className="flex-center p-normal-14 tracking-tight gap-3">
                        {link}
                        {index != menuLinks.length - 1 && <svg width="10" height="9" viewBox="0 0 10 9" fill="none" xmlns="http://www.w3.org/2000/svg">
